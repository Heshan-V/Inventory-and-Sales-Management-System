...
public class tables {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //st.executeUpdate("insert into appuser(userRole,name,mobileNumber,email,password,address,status) values('SuperAdmin','Super Admin','12345','superadmin@gmail.com','admin','Sri lanka','Active')");
